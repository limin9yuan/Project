	...
	a.extend(a.jqx._jqxGrid.prototype, {
		selectallrows : function() {
			...
			for (var c = 0; c < d; c++) {
				var f = e[c];
				if (!f) {
					this.selectedrowindexes[c] = c;continue
				}
		...
		unselectallrows : function() {
			...
			for (var b = 0; b < c; b++) {
				var e = d[b];
				if (!e) {
					this.selectedrowindexes[b] = b;continue
				}
		...
		getselectedcell : function() {
			...
			b.value = this.getcellvalue(b.row, b.column);return b
		},
		...
		copyselection : function() {
				...
				for (var c = n; c <= k; c++) {
					...
					if (this.clipboardselection[c] != undefined) {
						a.each(this.clipboardselection[c], function(i, o) {
							...
							m._clipboardselection[m._clipboardselection.length - 1][f] = p;f++;
							g += p
						})
					}
					if (c < k) {
			...
			this.clipboardselectedtext = g;return g
		},
					...
					for (var k = 0; k < this._clipboardselection[r].length; k++) {
						...
						if (d != null) {
							...
							this._raiseEvent(17, {
								...
								value : d
							});this.setcellvalue(f, n.column, d, false);this._raiseEvent(18, {
								rowindex : f,
								datafield : n.datafield,
			...
			if (i) {
				...
				if (d == -1) {
					...
					if (this.selectionmode == "multiplerows") {
						this.selectedrowindexes.splice(d, 1);this._raiseEvent(3, {
		...
		_applycellselection : function(e, b, h, f) {
			...
			if (h) {
				...
				if (!this.selectedcells[g]) {
					this.selectedcells[g] = i;this.selectedcells.length++;this._raiseEvent(15, i)
				} else {
		...
		_clearhoverstyle : function() {
			...
			if (b.length > 0) {
				b.removeClass(this.toTP("jqx-grid-cell-hover"));b.removeClass(this.toTP("jqx-fill-state-hover"))
			}
			this.hoveredrow = -1
		},
			...
			for (var g = 0; g < k; g++) {
				...
				for (var e = 0; e < f; e++) {
					...
					if (d.className.indexOf("jqx-grid-cell-selected") != -1) {
						n.removeClass(l);n.removeClass(c)
					}
					if (d.className.indexOf("jqx-grid-cell-hover") != -1) {
						n.removeClass(m);n.removeClass(h)
					}
				}
			}
		},
		...
		_selectrowwithmouse : function(p, b, c, f, d, s) {
			...
			if (this.selectionmode == "multiplerows" || this.selectionmode == "multiplecells" || this.selectionmode == "checkbox" || (this.selectionmode.indexOf("multiple") != -1 && (s == true || d == true))) {
				...
				this._clearselectstyle();this._selectrowwithstyle(p, t, true, f);
				if (this.selectionmode.indexOf("cell") != -1) {
					this._selectcellwithstyle(p, true, k, f, t)
				}
			}
		...
		_selectcellwithstyle : function(d, c, g, f, e) {
			...
			b.removeClass(this.toTP("jqx-grid-cell-hover"));b.removeClass(this.toTP("jqx-fill-state-hover"));
			if (c) {
				b.addClass(this.toTP("jqx-grid-cell-selected"));b.addClass(this.toTP("jqx-fill-state-pressed"))
			} else {
				b.removeClass(this.toTP("jqx-grid-cell-selected"));b.removeClass(this.toTP("jqx-fill-state-pressed"))
			}
		},
		_selectrowwithstyle : function(e, h, b, j) {
			...
			for (var g = f; g < c; g++) {
				var d = h.cells[g];
				if (b) {
					a(d).removeClass(this.toTP("jqx-grid-cell-hover"));a(d).removeClass(this.toTP("jqx-fill-state-hover"));
					if (e.selectionmode.indexOf("cell") == -1) {
						a(d).addClass(this.toTP("jqx-grid-cell-selected"));a(d).addClass(this.toTP("jqx-fill-state-pressed"))
					}
				} else {
					a(d).removeClass(this.toTP("jqx-grid-cell-hover"));a(d).removeClass(this.toTP("jqx-grid-cell-selected"));a(d).removeClass(this.toTP("jqx-fill-state-hover"));a(d).removeClass(this.toTP("jqx-fill-state-pressed"))
				}
			}
		},
		_handlemousemoveselection : function(ab, o) {
			...
			if ((o.selectionmode == "multiplerowsextended" || o.selectionmode == "multiplecellsextended" || o.selectionmode == "multiplecellsadvanced") && o.mousecaptured) {
				...
				if (Math.abs(this.mousecaptureposition.left - M) > 3 || Math.abs(this.mousecaptureposition.top - L) > 3) {
					...
					J -= Z.left;
					g -= Z.top;this.selectionarea.css("visibility", "visible");
					...
					this.selectionarea.width(H);this.selectionarea.height(P);this.selectionarea.css("left", J);this.selectionarea.css("top", g)
				}
			}
		},
		_handlemouseupselection : function(u, o) {
			...
			if (this.selectionarea[0].style.visibility != "visible") {
				o.mousecaptured = false;return true
			}
		...
		selectprevcell : function(e, c) {
			...
			if (d != null) {
				this.clearselection();this.selectcell(e, d.datafield)
			}
		},
		selectnextcell : function(e, d) {
			...
			if (b != null) {
				this.clearselection();this.selectcell(e, b.datafield)
			}
		},
		...
		_handlekeydown : function(x, q) {
							...
							if (q._cancelkeydown == undefined || q._cancelkeydown == false) {
								if (q.editmode !== "selectedrow") {
									...
									if (q.editcell && !q.editcell.validated) {
										q._rendervisualrows();q.endcelledit(q.editcell.row, q.editcell.column, false, true);return false
									}
								} else {
									return true
								}
							} else {
								q._cancelkeydown = false;return true
							}
						} else {
							q._cancelkeydown = false;return true
						}
				...
				if (this.clipboard) {
					...
					if (b == "c" || b == "x") {
						...
						if (window.clipboardData) {
							...
							g.val(o);a("body").append(g);g.select();setTimeout(function() {
								document.designMode = "off";g.select();g.remove();q.focus()
							}, 100)
						}
					} else {
						if (b == "v") {
							var C = a('<textarea style="position: absolute; left: -1000px; top: -1000px;"/>');
							a("body").append(C);C.select();
							var j = this;
							setTimeout(function() {
								...
								j.pasteselection();C.remove();j.focus()
							}, 100)
						}
					}
					if (b == "x") {
						this.deleteselection();this.host.focus()
					}
				}
			}
					...
					var s = function(K, G, J) {
						var F = function(O, L) {
							...
							if (N != undefined && L != null) {
								...
								p = true;q.ensurecellvisible(O, L);return true
							}
							return false
						};
						if (!F(K, G)) {
							q.ensurecellvisible(K, G);F(K, G);
							if (q.virtualmode) {
								q.host.focus()
							}
						}
			...
			case "multiplerowsadvanced":
				...
				i = this.getrowvisibleindex(i);var w = function(G, H) {
					var F = function(K) {
						...
						if (M != undefined) {
							...
							q.selectedrowindex = J;q.selectrow(L, false);
					...
					if (x.shiftKey && D != 9) {
						if (q.selectionmode == "multiplerowsextended") {
							if (q._lastClickedCell) {
								q._selectrowpath(G);
								q.selectedrowindex = q.getrowboundindex(G);return
							}
						}
					} else {
						if (!x.shiftKey) {
				...
				if (this.selectionmode.indexOf("cell") != -1 || this.selectionmode == "checkbox") {
					...
					if (e != -1) {
						...
						if (b.className.indexOf("jqx-grid-cell-selected") == -1) {
							...
							a(b).addClass(this.toTP("jqx-grid-cell-hover"));a(b).addClass(this.toTP("jqx-fill-state-hover"));
							if (this.cellhover) {
