...
function getEmptyRow(){
    var rowdata = {
         name : '<div class="product"><input name="name" readonly type="text" class="editable left" isvalid="no"/><span class="ui-icon-ellipsis"></span></div>',
         ...
         requireQty: '<input name="requireQty" type="text" class="editable left decimal" onkeyup="this.value=this.value.replace(/\D/g,\'\')" onafterpaste="this.value=this.value.replace(/\D/g,\'\')"  />',//需求数量
