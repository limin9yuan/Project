...
import com.dx.service.tender.fallback.ProjectServiceFallbackFactory;
...
public interface IProjectService {
    //保存
    @RequestMapping("/tender/projectService/save")
    @ResponseBody
    public ResultMsg save(@RequestBody ProjectBean projectBean,                         //立项申请信息
    ...
    //注销
    @RequestMapping("/tender/projectService/cancel")
    @ResponseBody
    public ResultMsg cancel(@RequestParam("projectId") String projectId);

    //删除
    @RequestMapping("/tender/projectService/remove")
    @ResponseBody
    public ResultMsg remove(@RequestParam("projectId") String projectId);

    //主要
    //返回数据类型ProjectApplyBean
    @RequestMapping("/tender/projectService/primary")
    @ResponseBody
    public ResultMsg primary(@RequestParam("projectId") String projectId);

    //获取元素
    //返回数据类型List<TenderElementBean>
    @RequestMapping("/tender/projectService/getElements")
    @ResponseBody
    public ResultMsg getElements(@RequestParam("projectId") String projectId);
    ...
    //返回Map类型
    @RequestMapping("/tender/projectService/search")
    @ResponseBody
