...
<eRedG4:div key="previewDiv" cls="x-hidden" ><img src="./resource/image/theme/default.jpg" /></eRedG4:div>
<eRedG4:div key="treeDiv" cls="x-hidden"></eRedG4:div>
<eRedG4:arm.MyViewport northTitle="${sysTitle}"
	westTitle="${westTitle}" />
</eRedG4:body>
</eRedG4:html>