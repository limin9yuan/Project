...
//								timeMax:$('#timeMax').data('date'),
						...
						columns : [
                              ...
                              var c=-1;
                               var m = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\'' + c + '\',\''+row.projectId+'\')"><i class="fa fa-edit"></i></a> ';
                                      ...
                                      if($('#Date1').val()==$('#Date8').val())
                                                {
                                                    if(row.idDate1== "" || row.idDate1== null || row.idDate1 == undefined)
                            ...
                            if($('#Date2').val()==$('#Date8').val())
                                 ...
                                 if(row.idDate2== "" || row.idDate2== null || row.idDate2 == undefined)
                                								...
                                								},
                            {
                               ...
                               align : 'center',
                               formatter : function(value, row, index) {
                              var a='<div  align=center><p>'+row.contentDate3+'<p><div2  align=center> <p2>'+row.normalDate3+'<p2> <p3>'+row.overDate3+'<p3></div2> ';
                              var c=-1;
                               var m = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\'' + c + '\',\''+row.projectId+'\')"><i class="fa fa-edit"></i></a> ';
                               var e = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\'' + row.idDate3 + '\')"><i class="fa fa-edit"></i></a> ';
                               ...
                               if($('#Date3').val()==$('#Date8').val())
                                                                {
                                                              if(row.idDate3== "" || row.idDate3== null || row.idDate3 == undefined)
                                								...
                                								},
                      {
                              ...
                              field : 'timesheetId',
                               align : 'center',
                               formatter : function(value, row, index) {
                               var a='<div  align=center><p>'+row.contentDate4+'<p><div2  align=center> <p2>'+row.normalDate4+'<p2> <p3>'+row.overDate4+'<p3></div2> ';
                               var c=-1;
                                                              var m = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\'' + c + '\',\''+row.projectId+'\')"><i class="fa fa-edit"></i></a> ';
                               var e = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\''
                                + row.idDate4
                               ...
                               + '\')"><i class="fa fa-remove"></i></a> ';
                                ...
                                + '\')"><i class="fa fa-key"></i></a> ';
                                                               ...
                                                               if($('#Date4').val()==$('#Date8').val())
                                                                                                {if(row.idDate4== "" || row.idDate4== null || row.idDate4 == undefined)
                                								...
                                								},
{
                               ...
                               align : 'center',
                               formatter : function(value, row, index) {
                               var a='<div  align=center><p>'+row.contentDate5+'<p><div2  align=center> <p2>'+row.normalDate5+'<p2> <p3>'+row.overDate5+'<p3></div2> ';
                               var c=-1;
                                                              var m = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\'' + c + '\',\''+row.projectId+'\')"><i class="fa fa-edit"></i></a> ';
                               var e = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\''
                                + row.idDate5
                               ...
                               + '\')"><i class="fa fa-remove"></i></a> ';
                                ...
                                + '\')"><i class="fa fa-key"></i></a> ';
                                     ...
                                     if($('#Date5').val()==$('#Date8').val())
                                                                      {
                                                                     if(row.idDate5== "" || row.idDate5== null || row.idDate5 == undefined)
                                								...
                                								},
{
                               ...
                               align : 'center',
                               formatter : function(value, row, index) {
                               var a='<div  align=center><p>'+row.contentDate6+'<p><div2  align=center> <p2>'+row.normalDate6+'<p2> <p3>'+row.overDate6+'<p3></div2> ';
                               var e = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\''
                                + row.idDate6
                               + '\')"><i class="fa fa-edit"></i></a> ';
                               var c=-1;
                               ...
                               + '\')"><i class="fa fa-remove"></i></a> ';
                                ...
                                + '\')"><i class="fa fa-key"></i></a> ';
                                         ...
                                         if($('#Date6').val()==$('#Date8').val())
                                                                          {
                                                                         if(row.idDate6== "" || row.idDate6== null || row.idDate6 == undefined)
                                								...
                                								},
{
                               ...
                               align : 'center',
                               formatter : function(value, row, index) {
                               var a='<div  align=center><p>'+row.contentDate7+'<p><div2  align=center> <p2>'+row.normalDate7+'<p2> <p3>'+row.overDate7+'<p3></div2> ';
                               var e = '<div  align=center><p>'+row.contentDate7+'<p><div><a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\''
                                + row.idDate7
                               + '\')"><i class="fa fa-edit"></i></a> ';
                               var c=-1;
                                                              var m = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\'' + c + '\',\''+row.projectId+'\')"><i class="fa fa-edit"></i></a> ';
                               ...
                               + '\')"><i class="fa fa-remove"></i></a> ';
                                ...
                                + '\')"><i class="fa fa-key"></i></a> ';
                                           ...
                                           if($('#Date7').val()==$('#Date8').val())
                                                                            {
                                                                           if(row.idDate7== "" || row.idDate7== null || row.idDate7 == undefined)
