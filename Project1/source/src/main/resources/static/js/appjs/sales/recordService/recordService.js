var prefix = "/sales/recordService"
$(function() {
						...
						columns : [
								{
									...
									sortable : true,
									align : 'center',
									field : 'serviceCreateTime',
									sortName:'Service_Create_Time',
									title : '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="sort" class="glyphicon glyphicon-sort">问题出现时间</button>'
								},{
									sortable : true,
									align : 'center',
									field : 'serviceRecordTime',
									sortName:'Service_Record_Time',
									title : '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="sort" class="glyphicon glyphicon-sort">问题记录时间</button>'
								},{
									align : 'center',
									field : 'serviceRecorderName',
									title : '问题记录人'
								},{
									align : 'center',
									field : 'serviceId',
