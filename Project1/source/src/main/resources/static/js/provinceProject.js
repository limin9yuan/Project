var addressResolve = function (options,optionValue) {
  ...
  this.projectInfo = $("#" + opts.projectId);
  /*省份初始化方法*/
    ...
    $.ajax({
		...
		success : function(data) {
            ...
            if (optValue.areaId != "") {
                ...
                addressInfo.areaInfo.trigger("change");
            }
		    addressInfo.areaInfo.chosen();
		    addressInfo.areaInfo.trigger("liszt:updated");
		}
  ...
  this.init = function () {
    ...
    addressInfo.provInfo.bind("change", addressInfo.selectProject);
    addressInfo.provInfo.bind("change", addressInfo.selectCity);
    addressInfo.cityInfo.bind("change", addressInfo.selectArea);
    addressInfo.cityInfo.bind("change", addressInfo.selectProject);
    addressInfo.areaInfo.bind("change", addressInfo.selectProject);
