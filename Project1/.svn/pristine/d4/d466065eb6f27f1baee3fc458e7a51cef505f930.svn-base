...
public class PurchaseServiceImpl implements PurchaseService {
	...
	@Override
	public List<PurchaseDetailDO> listDetail(Map<String, Object> map){
		return purchaseDao.listDetail(map);
	}

	@Override
	public int saveDetail(PurchaseDetailDO purchaseDetail){
		return purchaseDao.saveDetail(purchaseDetail);
	}

	@Override
	public int updateDetail(PurchaseDetailDO purchaseDetail){
		return purchaseDao.updateDetail(purchaseDetail);
	}
