...
function datetimepicker() {
	 $('#budgetOperateTimeMin').datetimepicker({
			...
			$('#budgetOperateTimeMax').data("DateTimePicker").minDate(new Date($('#budgetOperateTimeMin').data('date')));
		});
	 $('#budgetOperateTimeMax').datetimepicker({
	        format: 'YYYY-MM-DD ',
	        locale: moment.locale('zh-cn')
	    }).on('dp.change', function() {
			$('#budgetOperateTimeMin').data("DateTimePicker").maxDate(new Date($('#budgetOperateTimeMax').data('date')));
		});
}
