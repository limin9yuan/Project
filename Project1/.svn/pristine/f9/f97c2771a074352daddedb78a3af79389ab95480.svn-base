...
public class UserController extends BaseController {
	...
	@RequiresPermissions("sys:user:resetLogin")
	@Log("重置登录")
	@PostMapping("/resetLogin/{id}")
	@ResponseBody
	R resetLogin(@PathVariable("id") Long id) {
		UserDO userDO = userService.get(id);
	...
	@GetMapping("/treeAccount")
	@ResponseBody
	public Tree<DeptDO> treeAccount() {
		Tree<DeptDO> tree = new Tree<DeptDO>();
		tree = userService.getTreeAccount();
		return tree;
	}
	...
	public List<DictDO> listByType() {
		...
		map.put("type", "");
		List<DictDO> dictList = userService.listDic();
		return dictList;
	}
}
