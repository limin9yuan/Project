		...
		try {
			...
			if (list != null && !list.isEmpty()) {
				...
				for (int i = 0; i < list.size(); i++) {
					...
					hssfRow.createCell(20).setCellValue(CustomerStaffSize);
					// 信用等级
					...
					hssfRow.createCell(21).setCellValue(CustomerCreditRank);
					// 客户潜力
					String CustomerPotential = "";
					if (report.getCustomerPotential() != null) {
						CustomerPotential = report.getCustomerPotential();
					}
					hssfRow.createCell(22).setCellValue(CustomerPotential);
					// 员工数量
					...
					hssfRow.createCell(47).setCellValue(CustomerPaymentRate);
					// 企业占全市热化率
					...
					hssfRow.createCell(48).setCellValue(CustomerHeatingShare);
					// 投诉率
					...
					hssfRow.createCell(49).setCellValue(CustomerComplaintRate);
					// 供热面积
					...
					hssfRow.createCell(50).setCellValue(CustomerHeatingArea);
					// 热力站数量
					...
					hssfRow.createCell(51).setCellValue(CustomerHeatingSourceNumber);
					// 蒸汽面积
					...
					hssfRow.createCell(52).setCellValue(CustomerSteamArea);
					// 热水面积
					...
					hssfRow.createCell(53).setCellValue(CustomerHotWaterArea);
					// 自有热源
					...
					hssfRow.createCell(54).setCellValue(CustomerOwnHeatingSource);
					// 外购热源
					...
					hssfRow.createCell(55).setCellValue(CustomerOutHeatingSource);
					// 热耗'
					...
					hssfRow.createCell(56).setCellValue(CustomerHeatLoss);
					// 水耗
					...
					hssfRow.createCell(57).setCellValue(CustomerWaterLoss);
					//电耗
					...
					hssfRow.createCell(63).setCellValue(customerOperatorName);
					// 操作时间
					...
					hssfRow.createCell(18).setCellValue(getCustomerOperateTime);
				}
			}
			// 第七步，将文件输出到客户端浏览器
			try {
