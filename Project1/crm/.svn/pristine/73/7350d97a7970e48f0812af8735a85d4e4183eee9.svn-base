...
public class LaborDO implements Serializable {
	...
	//合计天数
	private Integer laborTotalDayNum;
	//投入百分比
	private BigDecimal laborRate;
	//合计工时数
	private Integer laborTotalHourNum;
	//人工成本合计
	 ...
	 * 设置：合计天数
	 */
	public void setLaborTotalDayNum(Integer laborTotalDayNum) {
		this.laborTotalDayNum = laborTotalDayNum;
	}
	/**
	 * 获取：合计天数
	 */
	public Integer getLaborTotalDayNum() {
	 ...
	 * 设置：合计工时数
	 */
	public void setLaborTotalHourNum(Integer laborTotalHourNum) {
		this.laborTotalHourNum = laborTotalHourNum;
	}
	/**
	 * 获取：合计工时数
	 */
	public Integer getLaborTotalHourNum() {
