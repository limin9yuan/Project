				...
				columns : [
                    ...
                    },
                    {
						...
						formatter:function(value,row,index){
                        	...
                        	var f = '<a class="btn btn-primary btn-sm " href="#" title="跟踪"  mce_href="#" onclick="trace(\''
								+ row.processDefinitionId+'\',\''+row.executionId
								+ '\')">跟踪<i class="fa"></i></a> ';
                        	return f;
						}
                    },
...
function trace(DefinitionId,executionId) {
	layer.open({
		type : 2,
		title : '流程图',
		maxmin : true,
		shadeClose : false,
		area : [ '800px', '520px' ],
		content : prefix + '/trace/photo/' + DefinitionId+'/'+executionId
	});
	layer.full(page);
}
