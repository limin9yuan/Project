...
public class BudgetPurchaseController {
	...
	@GetMapping()
	@RequiresPermissions("budget:budgetPurchase:budgetPurchase")
	String Purchase(){
	...
	@GetMapping("/add")
	@RequiresPermissions("budget:budgetPurchase:add")
	String add(){
	...
	@RequiresPermissions("budget:budgetPurchase:edit")
	...
	@PostMapping( "/remove")
	@ResponseBody
	@RequiresPermissions("budget:budgetPurchase:remove")
	...
	@ResponseBody
	@RequiresPermissions("budget:budgetPurchase:batchRemove")
