					...
					//	showColumns : true,
						...
						queryParams : function(params) {
							return {
								...
								assignmentBeginTime:$('#assignmentBeginTime').data('date')
					           // name:$('#searchName').val(),
						...
						columns : [
								{
									...
									title : '业务编号' 
																...
																{
									field : 'assignmentProjectCagegory', 
									title : '项目类别' 
								},																
																{
									field : 'assignmentDept', 
									title : '委托部门' 
								},
																{
									field : 'assignmentRecipientDept', 
									title : '承接部门' 
								},
																
																{
									field : 'assignmentTaskDescription', 
									title : '委托任务描述' 
								},
									...
									title : '任务完成时间' 
																...
																{
									field : 'assignmentRemarks', 
									title : '备注' 
								},
																{
									field : 'assignmentApprovalStatus', 
									title : '审批状态' 
								},
																{
									field : 'assignmentOperator', 
									title : '操作人' 
								},
																{
									field : 'assignmentOperateTime', 
									title : '修改时间' 
								},
																{
									field : 'assignmentCreator', 
									title : '创建人' 
								},
																{
									field : 'assignmentCreateTime', 
									title : '创建时间' 
								},*/
																 ]
					});
